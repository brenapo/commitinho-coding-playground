        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <img 
              ...
              className="w-24 h-24 commitinho-mascot animate-bounce-in"
            />
          </div>
        </div>
      </section>
      ...
      <section className="px-4 pb-16">
        <div className="max-w-6xl mx-auto">
              ...
              >
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div className="text-4xl mb-2 group-hover:animate-bounce-in">
                      {jogo.thumbnail}
                    </div>
                    {jogo.destaque && (
                ...
                <CardContent className="space-y-4">
                  ...
                  {/* Habilidades */}
                  <div>
                    <p className="text-sm font-medium text-commitinho-text mb-2">
                      Habilidades:
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {jogo.habilidades.map((habilidade) => (
                        <Badge 
                          key={habilidade}
                          className={coresHabilidades[habilidade as keyof typeof coresHabilidades]}
                        >
                          {habilidade}
                        </Badge>
                      ))}
          ...
          <div className="mt-16 text-center">
            <div className="bg-commitinho-surface rounded-2xl p-8 max-w-3xl mx-auto">
